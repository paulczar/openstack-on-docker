...
mysql -uroot -p$MYSQL_PASS -AN -e "GRANT ALL PRIVILEGES ON glance.* TO 'glance'@'localhost' \
IDENTIFIED BY '$GLANCE_DBPASS';"

mysql -uroot -p$MYSQL_PASS -AN -e "GRANT ALL PRIVILEGES ON glance.* TO 'glance'@'%' \
IDENTIFIED BY '$GLANCE_DBPASS';"
